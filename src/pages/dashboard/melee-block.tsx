  ...
  return (
    <div>
      <Table
        ...
        items={
          props.character.meleeWeapons.map((val, index) => ({ ...val, index }))
        }
...
function MeleeEditModal(props: MeleeEditModalProps) {
  const [editItem, setEditItem] = React.useState<MeleeTableItem>(props.item ?? {
    index: -1,
    name: "",
    dmgType: "",
    dmgAmt: "",
      ...
      <SpaceBetween direction="vertical" size="s">
        ...
        <FormField label="Effective Level">
          <Input
            ...
            type="number"
            onChange={({ detail }) => setEditItem({
              ...editItem, lvl: Number(detail.value)
            })}
          />
        </FormField>
